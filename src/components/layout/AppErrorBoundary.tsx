      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-wine-50">
          <div className="text-center p-8">
            ...
            <h1 className="text-2xl font-bold text-wine-800 mb-2">Something went wrong</h1>
            <p className="text-wine-600 mb-4">We encountered an error while loading WineBuddy</p>
            <button
