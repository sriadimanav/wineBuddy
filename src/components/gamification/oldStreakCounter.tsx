...
export function StreakCounter({
  ...
  const isActiveStreak =
    lastScanDate && new Date().getTime() - lastScanDate.getTime() < 24 * 60 * 60 * 1000; // Within 24 hours
  ...
  const containerStyle: React.CSSProperties = {
    background: isActiveStreak ? 'linear-gradient(135deg, #d4a574, #c49363)' : '#ffffff',
    ...
    animation: isActiveStreak && currentStreak > 0 ? 'pulse 2s infinite' : 'none',
  };
